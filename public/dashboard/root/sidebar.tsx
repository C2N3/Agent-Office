  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="sidebar-nav">
        {sections.map((section) => (
          <React.Fragment key={section.label}>
            <div className="nav-label" style={section.marginTop ? { marginTop: `${section.marginTop}px` } : undefined}>
              {section.label}
            </div>
      ...
      <div className="sidebar-footer">
        <div className="status-dot disconnected" id="statusIndicator" />
        <span id="connectionStatus">Connecting Gateway...</span>
        <a className="github-link" href="https://github.com/Mgpixelart/agent-office" target="_blank" rel="noreferrer" title="GitHub">
