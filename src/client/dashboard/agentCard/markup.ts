    ...
    <div class="mc-agent-header">
      <div class="mc-agent-identity">
        <div class="mc-agent-title-row">
          <div class="mc-agent-avatar" style="background-image:url('/assets/characters/${avatarFile}')"></div>
...
function tooltipAttrs(label: string): string {
  const text = escapeText(label);
  return `data-tooltip="${text}" aria-label="${text}"`;
}
