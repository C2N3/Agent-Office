...
export function setupTeamReportModal() {
  ...
  const mergeBtn = document.getElementById('teamReportMergeBtn') as HTMLButtonElement | null;
  const rejectBtn = document.getElementById('teamReportRejectBtn') as HTMLButtonElement | null;
