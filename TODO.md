...
- [ ] Migrate the remaining create-agent modal behavior in `src/client/dashboard/modals/createAgent.ts` from ID-based DOM binding toward React-owned component state and handlers.
