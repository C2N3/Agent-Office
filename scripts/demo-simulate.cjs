...
const agents = [
  { id: 'demo-agent-01', cwd: '/projects/agent-office',  model: 'claude-opus-4-6',    scenario: 'long'    },
...
const subagents = [
  { parentId: 'demo-agent-01', id: 'demo-sub-01a', cwd: '/projects/agent-office', agent_type: 'research',  spawnAfterMs: 8000,  durationMs: 18000 },
  { parentId: 'demo-agent-01', id: 'demo-sub-01b', cwd: '/projects/agent-office', agent_type: 'edit',      spawnAfterMs: 15000, durationMs: 12000 },
